...
Правила разработки на TypeScript, включая типизацию, стиль кода, безопасность и лучшие практики.
...
- Использовать строгую типизацию и избегать `any`, `unknown` и `{}` где возможно
...
- Правильно использовать ссылки на рабочее пространство (пакеты `@calls/*`)
