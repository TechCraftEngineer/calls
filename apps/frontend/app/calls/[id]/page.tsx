...
export default function CallDetailPage() {
  ...
  if (!call) return <div style={{ padding: '40px', textAlign: 'center' }}>Звонок не найден</div>;
          ...
          <div className="info-sidebar">
            <div className="sidebar-card">
              ...
              <div className="audio-player-container">
                {call.filename ? (
                  <AudioPlayer src={`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/records/${call.filename}`} />
                ) : (
