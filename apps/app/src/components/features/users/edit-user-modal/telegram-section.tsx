        ...
        {editUser.telegramChatId ? (
          ...
          <div className="flex gap-2 flex-wrap">
            <button
              type="button"
              onClick={onConnect}
              className="text-[13px] text-[#0088cc] bg-transparent border border-[#0088cc] rounded-md px-3 py-1.5 cursor-pointer flex items-center gap-1.5"
            >
              <svg
                width="14"
                height="14"
            ...
            <button
              ...
              className="text-[13px] text-[#666] bg-transparent border border-[#ddd] rounded-md px-3 py-1.5 cursor-pointer"
            >
