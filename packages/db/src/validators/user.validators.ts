...
export function validateCreateUserData(data: CreateUserData): void {
  ...
  if (data.internalExtensions !== undefined && data.internalExtensions !== null) {
    ...
    if (data.internalExtensions.length > 500) {
      throw new ValidationError('Internal extensions must be less than 500 characters');
    }
  }
  ...
  if (data.mobilePhones !== undefined && data.mobilePhones !== null) {
    ...
    if (data.mobilePhones.length > 500) {
      throw new ValidationError('Mobile phones must be less than 500 characters');
    }
  }
