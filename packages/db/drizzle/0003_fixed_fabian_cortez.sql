...
--> statement-breakpoint
DROP TABLE "workspace_megapbx_employees" CASCADE;--> statement-breakpoint
DROP TABLE "workspace_megapbx_links" CASCADE;--> statement-breakpoint
DROP TABLE "workspace_megapbx_numbers" CASCADE;--> statement-breakpoint
DROP TABLE "workspace_megapbx_sync_state" CASCADE;--> statement-breakpoint
DROP TABLE "workspace_megapbx_webhook_events" CASCADE;--> statement-breakpoint
