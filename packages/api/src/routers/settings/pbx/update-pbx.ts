  ...
  .handler(async ({ input, context }) => {
    ...
    await pbxService.updateSettings(
      context.workspaceId,
      {
        ...
        employeesPath: input.employeesPath || null,
        employeesResultKey: input.employeesResultKey || null,
        numbersPath: input.numbersPath || null,
        numbersResultKey: input.numbersResultKey || null,
        callsPath: input.callsPath || null,
        callsResultKey: input.callsResultKey || null,
        recordingsPath: input.recordingsPath || null,
        recordingsResultKey: input.recordingsResultKey || null,
